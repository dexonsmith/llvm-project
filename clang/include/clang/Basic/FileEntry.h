...
public:
  ...
  constexpr OptionalFileEntryRefDegradesToFileEntryPtr(FileEntryRef Ref)
...
static_assert(std::is_trivially_copyable<OptionalFileEntryRefDegradesToFileEntryPtr>::value,
